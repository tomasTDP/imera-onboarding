...
export default function SpVerify() {
  return (
    <PageTransition>
      <SinglePageLayout backTo="/sp/employer">
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-wisdom-grey">
              ...
              <span className="font-medium text-midnight-black">name@company.com</span>
            </p>
          </div>
          ...
          >
            <Link to="/sp/employer/setup">Continue</Link>
          </Button>
        </div>
      </SinglePageLayout>
    </PageTransition>
