...
export default function SpJoinCompany() {
    ...
    <PageTransition>
      <SinglePageLayout backTo="/">
        <div>
          ...
          <div className="rounded-xl border border-grey-200 bg-storyteller-sand px-4 py-3">
          ...
          <div className="mt-10">
            <SocialAuthButtons navigateTo="/sp/employee/welcome" />
          </div>
          ...
          >
            <Link to="/sp/employee/verify">Create Account</Link>
          </Button>
